    ...
    return (
        <section className="w-full py-20 rounded" style={backGround}>
            <div className="container px-4 sm:px-6 lg:px-8 flex flex-col items-start text-black mx-auto gap-3">
                ...
                <button onClick={() => {navigate("/appointment"); scrollTo(0,0)}} className="border-2 border-yellow-700 text-xl text-white font-bold px-8 py-4 mt-5 hover:bg-yellow-700 transition-all duration-500">Book an appointment</button>
            </div>
